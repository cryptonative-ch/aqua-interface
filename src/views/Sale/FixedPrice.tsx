...
import { PurchaseTokensForm } from 'src/views/components/PurchaseTokensForm'
import { HeaderControl } from 'src/views/components/HeaderControl'
import { SelfBidList } from 'src/views/components/SelfBidList'
import { TokenFooter } from 'src/views/components/TokenFooter'
import { HeaderItem } from 'src/views/components/HeaderItem'
import { SaleHeader } from 'src/views/components/SaleHeader'
import { HeaderClaim } from 'src/views/components/HeaderClaim'
