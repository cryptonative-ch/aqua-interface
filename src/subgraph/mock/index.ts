...
export const mocks = {
  ...
  FairSale: () => ({
    ...
    startDate: () => casual.random_element([1621249952]),
    endDate: () => casual.random_element([1621253552]),
  ...
  FixedPriceSale: () => ({
    ...
    updatedAt: () => casual.unix_time,
    deletedAt: () => casual.unix_time,
    startDate: () => casual.random_element([1621257152]),
    endDate: () => casual.random_element([1621260752]),
